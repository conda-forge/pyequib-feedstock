...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyequib-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10938&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyequib-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyequib` can be installed with:

```
conda install pyequib
```

It is possible to list all of the versions of `pyequib` available on your platform with:
